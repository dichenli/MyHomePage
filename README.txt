To Do list:
Find a picture for main page background (keep calm and carry on debugging)
select the best theme color (styles.css)
push more projects to github and added to timeline here.
Convert Jframe to Japplet programs and insert to this webpage
add a video tape of myself (ziggeo API) to introduce myself
    Hi, I'm Dichen Li. I'm a software and web developer.
    You can find more about my skills, experience, and
    perhaps personalities from this website. Also, feel
    free to contact me through email, or see my LinkedIn
    and Github homepage, from the links at the bottom of
    the page. Thank you!
